                                ...
                                <div className="w-full flex flex-col gap-2 mt-4 ">
                                    <div className="flex  gap-4 px-4 ">
                                        <div className=" object-cover overflow-hidden rounded-md relative ">
                                            ...
                                            <img src="https://i.ytimg.com/vi/pUYxthJ1BjU/hqdefault.jpg?sqp=-oaymwEcCPYBEIoBSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLCgzY-mfS-_uBL-iGhHjpifFfgNuQ" />
                                        </div>
                                        <div className="flex-1  justify-between flex">
                                            <div className="flex flex-col gap-2 ">
                                                ...
                                                <p className="text-white/30 text-sm mt-1">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laborum libero at quidem nesciunt aut, beatae praesentium commodi eos accusantium iste exercitationem esse adipisci nemo. Molestias possimus quam facere ut dolore!</p>
                                            </div>
